...
> Elastic Load Balancing supports three types of load balancers: Application Load Balancers, Network Load Balancers, and Classic Load Balancers. This guide discusses Application Load Balancers. For more information about Network Load Balancers, see the User Guide for [Network Load Balancers][2]. For more information about Classic Load Balancers, see the User Guide for [Classic Load Balancers][3].
> 
...
> With Amazon EFS, you pay only for the storage used by your file system. You don't need to provision storage in advance and there is no minimum fee or setup cost. For more information, see [Amazon EFS Pricing][9].
...
###[Relational Database Service][14]
...
> 
 ...
 - You can use the database products you are already familiar with: MySQL, MariaDB, PostgreSQL, Oracle, Microsoft SQL Server, and the new, MySQL-compatible Amazon Aurora DB engine (for information, see [Aurora on Amazon RDS][15]).
...
> DynamoDB allows you to delete expired items from tables automatically to help you reduce storage usage and the cost of storing data that is no longer relevant. For more information, see [Time To Live][17].
...
> 
> - Register domain names – Your website needs a name, such as example.com. Amazon Route 53 lets you register a name for your website or web application, known as a domain name. For an overview, see [How Domain Registration Works][25].
- Route internet traffic to the resources for your domain – When a user opens a web browser and enters your domain name in the address bar, Amazon Route 53 helps the Domain Name System (DNS) connect the browser with your website or web application. For an overview, see [How Internet Traffic Is Routed to Your Website or Web Application][26].
- Check the health of your resources – Amazon Route 53 sends automated requests over the internet to a resource, such as a web server, to verify that it's reachable, available, and functional. You also can choose to receive notifications when a resource becomes unavailable and choose to route internet traffic away from unhealthy resources. For an overview, see [How Amazon Route 53 Checks the Health of Your Resources][27].

###[Application Discovery Service][28]
...
> AWS CodeCommit is a version control service hosted by Amazon Web Services that you can use to privately store and manage assets (such as documents, source code, and binary files) in the cloud. For information about pricing for AWS CodeCommit, see [Pricing][40].
...
> 
> AWS CodeDeploy works with various systems for configuration management, source control, [continuous integration][43], [continuous delivery][44], and continuous deployment. For more information, see [Product and Service Integrations][45].

###[CodePipeline][46]

> AWS CodePipeline is a continuous delivery service you can use to model, visualize, and automate the steps required to release your software. You can quickly model and configure the different stages of a software release process. AWS CodePipeline automates the steps required to release your software changes continuously. For information about pricing for AWS CodePipeline, see [Pricing][47].
...
> 
> An AWS resource is an entity you can work with in AWS, such as an Amazon Elastic Compute Cloud (EC2) instance, an Amazon Elastic Block Store (EBS) volume, a security group, or an Amazon Virtual Private Cloud (VPC), for example. For a complete list of AWS resources supported by AWS Config, see [Supported AWS Resource Types][53].

###[OpsWorks][54]

> AWS OpsWorks is a configuration management service that helps you configure and operate applications in a cloud enterprise by using Chef. AWS OpsWorks Stacks and AWS OpsWorks for Chef Automate let you use [Chef][55] cookbooks and solutions for configuration management.
...
> 
> AWS Artifact Agreements is a feature of the AWS Artifact service that enables you to review, accept, and track the status of a Business Associate Addendum (BAA) agreement. A BAA typically is required for companies that are subject to the Health Insurance Portability and Accountability Act (HIPAA) to ensure that protected health information (PHI) is appropriately safeguarded. You can use AWS Artifact Agreements to enter into a BAA agreement with AWS and designate an AWS account that can legally process protected health information (PHI). For more information, see [Managing Your Agreements][60].

###[Certificate Manager][61]

> AWS Certificate Manager (ACM) handles the complexity of creating and managing SSL/TLS certificates for your AWS based websites and applications. You can use [certificates provided by ACM][62] (ACM Certificates) or [certificates that you import into ACM][63].
> 
> You cannot install an ACM Certificate directly on your website or application. You must install your certificate by using one of the services integrated with ACM. For more information about these services, see [Services Integrated with AWS Certificate Manager][64].
...
> Amazon EMR is a managed cluster platform that simplifies running big data frameworks, such as [Apache Hadoop][79] and [Apache Spark][80], on AWS to process and analyze vast amounts of data. By using these frameworks and related open-source projects, such as Apache Hive and Apache Pig, you can process data for analytics purposes and business intelligence workloads. Additionally, you can use Amazon EMR to transform and move large amounts of data into and out of other AWS data stores and databases, such as Amazon Simple Storage Service (Amazon S3) and Amazon DynamoDB.
...
> Use Amazon Kinesis Streams to collect and process large [streams][83] of data records in real time.
> 
> You'll create data-processing applications, known as Amazon Kinesis Streams applications. A typical Amazon Kinesis Streams application reads data from an Kinesis stream as data records. These applications can use the Kinesis Client Library, and they can run on Amazon EC2 instances. The processed records can be sent to dashboards, used to generate alerts, dynamically change pricing and advertising strategies, or send data to a variety of other AWS services. For information about Kinesis Streams features and pricing, see [Amazon Kinesis Streams][84].
...
###[Simple Notification Service][107]
...
> Unlike traditional on-premises solutions for desktop application streaming, AppStream 2.0 offers pay-as-you-go pricing, with no upfront investment and no infrastructure to maintain. You can scale instantly and globally, ensuring that your users always have the best possible experience.
  ...
  [1]: http://docs.aws.amazon.com/elasticloadbalancing/latest/application/introduction.html
  [2]: http://docs.aws.amazon.com/elasticloadbalancing/latest/network/
  [3]: http://docs.aws.amazon.com/elasticloadbalancing/latest/classic/
  [4]: http://docs.aws.amazon.com/AmazonECR/latest/userguide/what-is-ecr.html
  [5]: http://docs.aws.amazon.com/AmazonS3/latest/dev/Welcome.html
  [6]: http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/AmazonEBS.html
  [7]: http://aws.amazon.com/ebs/
  [8]: http://docs.aws.amazon.com/efs/latest/ug/whatisefs.html
  [9]: https://aws.amazon.com/efs/pricing
  [10]: http://docs.aws.amazon.com/amazonglacier/latest/dev/introduction.html
  [11]: https://aws.amazon.com/glacier
  [12]: http://docs.aws.amazon.com/snowball/latest/ug/whatissnowball.html
  [13]: http://docs.aws.amazon.com/storagegateway/latest/userguide/WhatIsStorageGateway.html
  [14]: http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Welcome.html
  [15]: http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_Aurora.html
  [16]: http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Introduction.html
  [17]: http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/TTL.html
  [18]: http://docs.aws.amazon.com/AmazonElastiCache/latest/UserGuide/WhatIs.html
  [19]: http://docs.aws.amazon.com/redshift/latest/gsg/getting-started.html
  [20]: http://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_Introduction.html
  [21]: http://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/Introduction.html
  [22]: http://docs.aws.amazon.com/directconnect/latest/UserGuide/Welcome.html
  [23]: http://docs.aws.amazon.com/directconnect/latest/UserGuide/images/direct_connect_overview.png
  [24]: http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/Welcome.html
  [25]: http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/welcome-domain-registration.html
  [26]: http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/welcome-dns-service.html
  [27]: http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/welcome-health-checks.html
  [28]: http://docs.aws.amazon.com/application-discovery/latest/userguide/what-is-appdiscovery.html
  [29]: https://aws.amazon.com/application-discovery/faqs/
  [30]: http://docs.aws.amazon.com/dms/latest/userguide/Welcome.html
  [31]: http://docs.aws.amazon.com/SchemaConversionTool/latest/userguide/CHAP_SchemaConversionTool.Installing.html
  [32]: http://docs.aws.amazon.com/migrationhub/latest/ug/whatishub.html
  [33]: https://aws-content-sandbox.aka.amazon.com/klebel/migration-hub/partners/#tools-partners
  [34]: https://aws-content-sandbox.aka.amazon.com/klebel/migration-hub/partners/#tools-partners
  [35]: https://us-west-2.awsc-integ.aws.amazon.com/migrationhub/migrate/tools
  [36]: http://docs.aws.amazon.com/server-migration-service/latest/userguide/server-migration.html
  [37]: http://docs.aws.amazon.com/SchemaConversionTool/latest/userguide/Welcome.html
  [38]: http://docs.aws.amazon.com/codestar/latest/userguide/welcome.html
  [39]: http://docs.aws.amazon.com/codecommit/latest/userguide/welcome.html
  [40]: http://aws.amazon.com/codecommit/pricing/
  [41]: http://docs.aws.amazon.com/codebuild/latest/userguide/welcome.html
  [42]: http://docs.aws.amazon.com/codedeploy/latest/userguide/welcome.html
  [43]: https://aws.amazon.com/devops/continuous-integration/
  [44]: https://aws.amazon.com/devops/continuous-delivery/
  [45]: https://aws.amazon.com/codedeploy/product-integrations/
  [46]: http://docs.aws.amazon.com/codepipeline/latest/userguide/welcome.html
  [47]: http://aws.amazon.com/codepipeline/pricing/
  [48]: http://docs.aws.amazon.com/xray/latest/devguide/aws-xray.html
  [49]: http://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/WhatIsCloudWatch.html
  [50]: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html
  [51]: http://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-user-guide.html
  [52]: http://docs.aws.amazon.com/config/latest/developerguide/WhatIsConfig.html
  [53]: http://docs.aws.amazon.com/config/latest/developerguide/resource-config-reference.html#supported-resources
  [54]: http://docs.aws.amazon.com/opsworks/latest/userguide/welcome.html
  [55]: https://www.chef.io/
  [56]: http://docs.aws.amazon.com/servicecatalog/latest/dg/what-is-service-catalog.html
  [57]: http://docs.aws.amazon.com/IAM/latest/UserGuide/introduction.html
  [58]: http://docs.aws.amazon.com/artifact/latest/ug/what-is-aws-artifact.html
  [59]: https://aws.amazon.com/compliance/shared-responsibility-model/
  [60]: http://docs.aws.amazon.com/artifact/latest/ug/managingagreements.html
  [61]: http://docs.aws.amazon.com/acm/latest/userguide/acm-overview.html
  [62]: http://docs.aws.amazon.com/acm/latest/userguide/gs-acm-request.html
  [63]: http://docs.aws.amazon.com/acm/latest/userguide/import-certificate.html
  [64]: http://docs.aws.amazon.com/acm/latest/userguide/acm-services.html
  [65]: http://docs.aws.amazon.com/cloudhsm/latest/userguide/introduction.html
  [66]: https://aws.amazon.com/cn/documentation/directory-service/
  [67]: https://docs.aws.amazon.com/inspector/latest/userguide/inspector_introduction.html
  [68]: http://docs.aws.amazon.com/kms/latest/developerguide/overview.html
  [69]: http://docs.aws.amazon.com/macie/latest/userguide/what-is-macie.html
  [70]: http://docs.aws.amazon.com/organizations/latest/userguide/orgs_introduction.html
  [71]: http://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html
  [72]: http://docs.aws.amazon.com/waf/latest/developerguide/shield-chapter.html
  [73]: http://docs.aws.amazon.com/athena/latest/ug/what-is.html
  [74]: http://docs.aws.amazon.com/cloudsearch/latest/developerguide/what-is-cloudsearch.html
  [75]: http://docs.aws.amazon.com/datapipeline/latest/DeveloperGuide/what-is-datapipeline.html
  [76]: http://docs.aws.amazon.com/elasticsearch-service/latest/developerguide/what-is-amazon-elasticsearch-service.html
  [77]: https://www.elastic.co/guide/en/elasticsearch/reference/current/getting-started.html
  [78]: http://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-what-is-emr.html
  [79]: https://aws.amazon.com/elasticmapreduce/details/hadoop
  [80]: https://aws.amazon.com/elasticmapreduce/details/spark
  [81]: http://docs.aws.amazon.com/glue/latest/dg/what-is-glue.html
  [82]: http://docs.aws.amazon.com/streams/latest/dev/introduction.html
  [83]: https://aws.amazon.com/streaming-data/
  [84]: https://aws.amazon.com/kinesis/streams/
  [85]: http://docs.aws.amazon.com/quicksight/latest/user/welcome.html
  [86]: http://docs.aws.amazon.com/redshift/latest/gsg/getting-started.html
  [87]: http://docs.aws.amazon.com/lex/latest/dg/what-is.html
  [88]: http://docs.aws.amazon.com/polly/latest/dg/what-is.html
  [89]: http://docs.aws.amazon.com/rekognition/latest/dg/what-is.html
  [90]: http://docs.aws.amazon.com/machine-learning/latest/dg/what-is-amazon-machine-learning.html
  [91]: http://docs.aws.amazon.com/greengrass/latest/developerguide/what-is-gg.html
  [92]: http://docs.aws.amazon.com/greengrass/latest/developerguide/images/greengrass.png
  [93]: http://docs.aws.amazon.com/iot/latest/developerguide/what-is-aws-iot.html
  [94]: http://docs.aws.amazon.com/connect/latest/adminguide/what-is-amazon-connect.html
  [95]: http://docs.aws.amazon.com/lumberyard/latest/userguide/lumberyard-intro.html
  [96]: http://docs.aws.amazon.com/gamelift/latest/developerguide/gamelift-intro.html
  [97]: http://docs.aws.amazon.com/mobile-hub/latest/developerguide/what-is-mobile-hub.html
  [98]: http://docs.aws.amazon.com/apigateway/latest/developerguide/welcome.html
  [99]: http://docs.aws.amazon.com/cognito/latest/developerguide/what-is-amazon-cognito.html
  [100]: http://docs.aws.amazon.com/devicefarm/latest/developerguide/welcome.html
  [101]: http://docs.aws.amazon.com/mobileanalytics/latest/ug/welcome.html
  [102]: http://docs.aws.amazon.com/mobileanalytics/latest/ug/images/analytics-overview.png
  [103]: http://docs.aws.amazon.com/pinpoint/latest/developerguide/welcome.html
  [104]: http://docs.aws.amazon.com/elastictranscoder/latest/developerguide/introduction.html
  [105]: http://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-welcome.html
  [106]: http://docs.aws.amazon.com/step-functions/latest/dg/welcome.html
  [107]: http://docs.aws.amazon.com/sns/latest/dg/welcome.html
  [108]: http://docs.aws.amazon.com/sns/latest/dg/images/sns-how-works.png
  [109]: http://docs.aws.amazon.com/ses/latest/DeveloperGuide/Welcome.html
  [110]: https://aws.amazon.com/ses/
  [111]: http://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/Welcome.html
  [112]: http://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/standard-queues.html
  [113]: http://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/FIFO-queues.html
  [114]: http://docs.aws.amazon.com/zh_cn/workdocs/latest/adminguide/what_is.html
  [115]: http://docs.aws.amazon.com/workmail/latest/userguide/what_is.html
  [116]: http://docs.aws.amazon.com/chime/latest/ag/what-is-chime.html
  [117]: http://docs.aws.amazon.com/workspaces/latest/adminguide/amazon-workspaces.html
  [118]: http://docs.aws.amazon.com/appstream2/latest/developerguide/what-is-appstream.html
